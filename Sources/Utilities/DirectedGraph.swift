...
///
/// Use `DirectedGraph<V, NoLabel>` rather than `DirectedGraph<V, Void>` to implement an unlabeled
/// graph to support the synthesization of structural conformance (e.g., to `Equatable`).
public struct DirectedGraph<Vertex: Hashable & Sendable, Label: Sendable>: Sendable {
  ...
  public subscript(from source: Vertex) -> OutgoingEdges {
    get { out[source, default: [:]] }
    set { out[source] = newValue }
