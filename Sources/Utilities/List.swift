...
public struct List<Element> {
  ...
  public struct Addresses {
    ...
    private var base: List.Indices

    fileprivate init(_ base: List) {
...
extension List: BidirectionalCollection, MutableCollection {
...
extension List.Address: CustomStringConvertible {

  public var description: String { String(describing: rawValue) }

}

extension List.Addresses: BidirectionalCollection {

  public typealias Index = List.Indices.Index

  public typealias Element = List.Address
  ...
  public subscript(position: Index) -> List.Address {
